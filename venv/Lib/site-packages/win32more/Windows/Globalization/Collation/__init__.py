...
class CharacterGrouping(ComPtr):
    ...
    @winrt_mixinmethod
    def get_First(self: win32more.Windows.Globalization.Collation.ICharacterGrouping) -> hstr: ...
    @winrt_mixinmethod
    def get_Label(self: win32more.Windows.Globalization.Collation.ICharacterGrouping) -> hstr: ...
...
class CharacterGroupings(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: win32more.Windows.Globalization.Collation.ICharacterGroupingsFactory, language: hstr) -> win32more.Windows.Globalization.Collation.CharacterGroupings: ...
    @winrt_mixinmethod
    def Lookup(self: win32more.Windows.Globalization.Collation.ICharacterGroupings, text: hstr) -> hstr: ...
    @winrt_mixinmethod
...
class ICharacterGroupings(ComPtr):
    ...
    @winrt_commethod(6)
    def Lookup(self, text: hstr) -> hstr: ...
class ICharacterGroupingsFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self, language: hstr) -> win32more.Windows.Globalization.Collation.CharacterGroupings: ...
