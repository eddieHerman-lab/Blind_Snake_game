...
class IOemSupportInfo(ComPtr):
    ...
    @winrt_commethod(8)
    def get_SupportProvider(self) -> hstr: ...
...
class ISystemSupportInfoStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_LocalSystemEdition(self) -> hstr: ...
    @winrt_commethod(7)
...
class OemSupportInfo(ComPtr):
    ...
    @winrt_mixinmethod
    def get_SupportProvider(self: win32more.Windows.System.Profile.SystemManufacturers.IOemSupportInfo) -> hstr: ...
    SupportAppLink = property(get_SupportAppLink, None)
    SupportLink = property(get_SupportLink, None)
    SupportProvider = property(get_SupportProvider, None)
...
class SmbiosInformation(ComPtr, metaclass=_SmbiosInformation_Meta_):
    ...
    @winrt_classmethod
    def get_SerialNumber(cls: win32more.Windows.System.Profile.SystemManufacturers.ISmbiosInformationStatics) -> hstr: ...
...
class SystemSupportDeviceInfo(ComPtr):
    ...
    @winrt_mixinmethod
    def get_OperatingSystem(self: win32more.Windows.System.Profile.SystemManufacturers.ISystemSupportDeviceInfo) -> hstr: ...
    @winrt_mixinmethod
    def get_FriendlyName(self: win32more.Windows.System.Profile.SystemManufacturers.ISystemSupportDeviceInfo) -> hstr: ...
    @winrt_mixinmethod
    def get_SystemManufacturer(self: win32more.Windows.System.Profile.SystemManufacturers.ISystemSupportDeviceInfo) -> hstr: ...
    @winrt_mixinmethod
    def get_SystemProductName(self: win32more.Windows.System.Profile.SystemManufacturers.ISystemSupportDeviceInfo) -> hstr: ...
    @winrt_mixinmethod
    def get_SystemSku(self: win32more.Windows.System.Profile.SystemManufacturers.ISystemSupportDeviceInfo) -> hstr: ...
    @winrt_mixinmethod
    def get_SystemHardwareVersion(self: win32more.Windows.System.Profile.SystemManufacturers.ISystemSupportDeviceInfo) -> hstr: ...
    @winrt_mixinmethod
    def get_SystemFirmwareVersion(self: win32more.Windows.System.Profile.SystemManufacturers.ISystemSupportDeviceInfo) -> hstr: ...
    FriendlyName = property(get_FriendlyName, None)
    OperatingSystem = property(get_OperatingSystem, None)
    SystemFirmwareVersion = property(get_SystemFirmwareVersion, None)
    SystemHardwareVersion = property(get_SystemHardwareVersion, None)
...
class SystemSupportInfo(ComPtr, metaclass=_SystemSupportInfo_Meta_):
    ...
    @winrt_classmethod
    def get_LocalSystemEdition(cls: win32more.Windows.System.Profile.SystemManufacturers.ISystemSupportInfoStatics) -> hstr: ...
    @winrt_classmethod
